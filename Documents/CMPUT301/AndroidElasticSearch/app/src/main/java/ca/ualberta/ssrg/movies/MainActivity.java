...
public class MainActivity extends Activity {
	...
	protected void onResume() {
		...
		//SearchThread thread = new SearchThread("*"); // search for anything (indicated by empty string
	...
	class SearchThread extends Thread {
        ...
        // constructor that stores whatever is passed in
		public SearchThread(String search) {
            this.search = search;
        }

        // code that runs in other thread goes in run method
        @Override
        public void run() {
            // clear main list of movies
            movies.clear();

            // add back movies from search
