...
int main(int argc, char *argv[])
{
  ...
  start_game(executable, &landscape, grav_val, thrust_val);
...
void draw_image(FILE *executable, struct Image *image)
{
  int i = 0;
...
void erase_image(FILE *executable, struct Image *image)
{
  int i = 0;
